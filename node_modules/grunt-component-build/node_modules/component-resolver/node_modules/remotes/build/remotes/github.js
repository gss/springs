...
GitHub.prototype._versions = regeneratorRuntime.mark(function callee$0$0(repo) {
  var uri, res, err;
  ...
  return regeneratorRuntime.wrap(function callee$0$0$(context$1$0) {
    ...
    case 0:
      ...
      debug('GET "%s"', uri);
      API_COUNTER++;
      return context$1$0.delegateYield(this.request(uri, true), "t0", 4);
    case 4:
      res = context$1$0.t0;
...
GitHub.prototype._json = regeneratorRuntime.mark(function callee$0$1(repo, ref) {
...
GitHub.prototype._tree = regeneratorRuntime.mark(function callee$0$2(repo, ref) {
  var uri, res, err;
  ...
  return regeneratorRuntime.wrap(function callee$0$2$(context$1$0) {
    ...
    case 0:
      ...
      debug('GET "%s"', uri);
      API_COUNTER++;
      return context$1$0.delegateYield(this.request(uri, true), "t3", 4);
    case 4:
      res = context$1$0.t3;
